    ...
    <div className={"contenedor main-form-flex-container"}>
          ...
          <Card.Body>
            <Card.Text className={"text"}>
              {mainData.data?.docs[0]
                ...
                : "Por favor introduzca un título en su dashboard"}
            </Card.Text>
            <Card.Text className={"text2"}>
              {mainData.data?.docs[0]
                ? mainData.data?.docs[0].mainSubtitle
                : "Por favor introduzca un subtítulo en su dashboard"}
            </Card.Text>
          </Card.Body>
        </Card.ImgOverlay>
      </Card>
      <div className={"container instructions"}>
        {mainData.data?.docs[0]
          ...
          : "Por favor introduzca un texto de intrucción en su dashboard"}
      </div>
        ...
        <div hidden={showFindForm} className={"container container-content"}>
          ...
          <Form onSubmit={click} noValidate validated={validated}>
            <h3 className="find-her-mp-text">
              Encuentre aquí a su representante local:
            </h3>
            <Form.Group>
              <Form.Control
                type="email"
